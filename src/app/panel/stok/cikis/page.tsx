...
export default function StokCikisPage() {
  ...
  return (
    <div className="panel-page max-w-lg space-y-6">
      ...
      <h1 className="panel-heading">Satış (Stok Çıkışı)</h1>
      ...
      >
        <div>
          ...
          <input
            ...
            onChange={(e) => { setSearch(e.target.value); setProduct(null); searchProducts(); }}
        ...
        <label className="flex items-center gap-2 cursor-pointer text-sm text-amber-800">
          ...
          İzinli devam (negatif stok) — not zorunlu, log ve raporda işaretlenir
        </label>
