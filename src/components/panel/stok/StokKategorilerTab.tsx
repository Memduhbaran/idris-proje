...
export function StokKategorilerTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap gap-3 items-center">
        <input type="search" placeholder="Kod veya ad ile ara..." value={q} onChange={(e) => setQ(e.target.value)} className="panel-input w-64 max-w-full" />
